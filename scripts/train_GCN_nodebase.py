...
# Dataset 
dataset_name = 'PearC_EdgeW_PearC_Sp56.25_raw_Sex' # Choose type of dataset: Sex, Handedness
...
for train_loader, val_loader in zip(train_loaders, val_loaders):
    ...
    #scheduler = optim.lr_scheduler.StepLR(optimizer, step_size= 5, gamma= 0.97) #initial_lr=0.01,gamma= 0.97
