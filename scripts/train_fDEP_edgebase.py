...
for train_loader, val_loader in zip(train_loaders, val_loaders):
    ...
    results_filename = '/home/path/training_results.csv'
    ...
    # Check if file exists to determine whether to write header
    wtable_filename = '/home/path/weights_table.csv'
    ...
    torch.save(sampler.state_dict(), f"/home/path/DEP_{fold}.pth")
    torch.save(model.state_dict(), f"/home/path/DEP_{fold}.pth")